...
class ListNode {
   ...
   */
    ...
    */
    ...
    const filledList = new SinglyLinkedList().insertAtBackMany([4, 12, 3, 5, 17, 19, 30]);
    

    console.log(filledList.toArr());
    console.log(filledList.removeBack());
  ...
  // console.log(firstThreeList.toArr());
    ...
    console.log(unorderedList.contains(6));
    console.log(unorderedList.contains(-7));
    console.log(emptyList.contains(8));