...
class DoublyLinkedList {
    ...
    removeMiddleNode() {
        ...
        //if two, remove one, then update head or tail
        if (length===2){
          output=this.head.data;
          this.head=this.tail;
          this.tail.prev=null;
        ...
        //reassign .previous node's .next property
        runner.prev.next = runner.next;
        
        //reassign .next node's previous property
...
console.log(unorderedList.findLength());
