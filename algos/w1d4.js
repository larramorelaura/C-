...
class ListNode {
  ...
  class SinglyLinkedList {
     ...
     */
    removeVal(val) {
        //edge cases: val not in list, list empty, val is the head
        if(this.isEmpty())
        {
            return false;
        }
        ...
        //make a runner that equals this.head
        let runner= this.head;
        //while loop that looks for while a runner has a next and the runner.next isn't val
        ...
        //reassign runner.next to runner.next.next
        //return true
        //if we get to the end and haven't removed anything return false
    }
  ...
  */
  ...
  const unorderedList = new SinglyLinkedList().insertAtBackMany([
    ...
    console.log(singleNodeList.removeVal(0))
    console.log(biNodeList.removeVal(2))
    console.log(firstThreeList.removeVal(2))
    console.log(secondThreeList.removeVal(0))
    console.log(unorderedList.removeVal(-7))
